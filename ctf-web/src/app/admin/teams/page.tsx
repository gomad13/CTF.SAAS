...
export default function TeamsPage() {
    ...
    const createM = useMutation({
        ...
        onSuccess: () => {
            ...
            setShowCreate(false); setName(""); setDescription(""); setColor("#3B82F6"); setIcon("Users"); setMaxMembers("");
            setFormError(null);
        },
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-6 sm:px-6 sm:py-8">
            <div className="flex flex-wrap items-end justify-between gap-4">
                ...
                <button
                    ...
                    className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-white transition-colors duration-200 hover:bg-primary-hover sm:w-auto"
                >
                    <Plus size={14} />
                    Nouvelle équipe
                </button>
            ...
            {showCreate && (
                <section className="rounded-xl border border-[#E2E8F0] bg-white p-6 shadow-sm">
                    ...
                    {formError && <div className="mt-3 text-xs text-[#B91C1C]">{formError}</div>}
