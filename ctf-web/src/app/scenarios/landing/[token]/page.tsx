        ...
        <div style={{ minHeight: "100vh", background: "linear-gradient(135deg,#0F172A 0%,#1E293B 100%)", padding: "48px 24px" }}>
            <div style={{ maxWidth: 720, margin: "0 auto" }}>
                ...
                <div style={{
                    ...
                    <div style={{ width: 56, height: 56, borderRadius: 12, background: "rgba(239,68,68,0.20)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                        <ShieldAlert size={28} color="#FCA5A5" strokeWidth={1.75} />
                    </div>
                    <div>
                        <h1 style={{ fontSize: 24, fontWeight: 700, color: "#FCA5A5", margin: 0 }}>Tu viens de cliquer sur un lien piégé</h1>
                        <p style={{ fontSize: 14, color: "#FECACA", margin: "8px 0 0", lineHeight: 1.6 }}>
                            {"Bonne nouvelle : c'est une simulation Viper, pas une vraie attaque."} <strong>{"Aucun mot de passe, RIB ou virement n'est en jeu."}</strong>{" "}{"Mais imagine 2 secondes que c'était vrai — c'est exactement à ça qu'on s'entraîne."}
                        </p>
                    </div>
                </div>
                ...
                {landing.scenarioName && (
                    <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 12, padding: 20, marginBottom: 24 }}>
                        ...
                        <div style={{ fontSize: 16, color: "#F1F5F9", fontWeight: 500 }}>{landing.scenarioName}</div>
                ...
                {landing.hints.length > 0 && (
                    <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 12, padding: 24, marginBottom: 24 }}>
                ...
                {coaching && (
                    <div style={{ background: "rgba(59,130,246,0.08)", border: "1px solid rgba(59,130,246,0.25)", borderRadius: 12, padding: 24, marginBottom: 24 }}>
                        ...
                        <p style={{ fontSize: 13.5, color: "#DBEAFE", lineHeight: 1.7, whiteSpace: "pre-wrap", margin: 0 }}>{coaching.content}</p>
                    </div>
                )}
                {coachingLoading && (
                ...
                <div style={{ display: "flex", gap: 12, justifyContent: "center", marginTop: 32 }}>
                    ...
                    <Link href="/dashboard" style={{
                        display: "inline-flex", alignItems: "center", gap: 8,
                        padding: "12px 20px", border: "1px solid rgba(255,255,255,0.10)", color: "#CBD5E1",
                        borderRadius: 8, fontSize: 14, fontWeight: 500, textDecoration: "none",
